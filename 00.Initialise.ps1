...
# NOTE: By default, Salesforce Weekly Export uses ISO-8859-1 encoding, which isn't one of the options supported by PowerShell.
# We'll _probably_ get better results by selecting UTF8 instead. (TO BE CONFIRMED.)
